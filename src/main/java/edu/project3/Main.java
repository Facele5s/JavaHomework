...
import edu.project3.Formatters.AdocReportCreator;
import edu.project3.Formatters.MarkdownReportCreator;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (format.equals("Markdown")) {
                ...
                reportCreator.saveReport("src/main/java/edu/project3/someLogs.md");
            } else {
                AdocReportCreator reportCreator = new AdocReportCreator(path, logs, dateFrom, dateTo);
                reportCreator.setFromDate(dateFrom);
                reportCreator.setToDate(dateTo);
                reportCreator.printReport();
                reportCreator.saveReport("src/main/java/edu/project3/someLogs.adoc");
            }
